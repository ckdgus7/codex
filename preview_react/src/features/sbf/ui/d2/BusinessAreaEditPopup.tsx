...
import type { BusinessAreaFormData } from "@/features/sbf/ui/d2/BusinessAreaCreatePopup";

interface BusinessAreaEditPopupProps {
  open: boolean;
  onClose: () => void;
...
export function BusinessAreaEditPopup({
  open,
  onClose,
  data,
  hasActiveChildren = false,
  onSave,
}: BusinessAreaEditPopupProps) {
  ...
  }, [data, lifecycleId, nameKo, description, useYn]);
  ...
  const handleSave = () => {
    ...
    const saved: BusinessAreaFormData = {
      lifecycleId,
      lifecycleNameKo: selectedLifecycle?.nameKo || data.lifecycleNameKo,
      category,
      nameKo,
      description,
      useYn,
          ...
          <div style={s.popup} onClick={(e) => e.stopPropagation()}>
            <div style={s.header}>
              <div style={s.titleRow}>
                <span style={s.titleText}>업무영역(D2) 수정</span>
